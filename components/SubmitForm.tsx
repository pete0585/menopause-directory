  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <p className="text-center text-xs text-gray-400">
        Free listings are reviewed and approved within 1–2 business days. Upgrade to Verified for $49/year to get a badge, priority placement, and direct booking link.
      </p>
    </form>
  )
}
