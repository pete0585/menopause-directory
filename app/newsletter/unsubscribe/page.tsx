...
function UnsubscribeContent() {
  ...
  const niche = searchParams.get('niche') ?? 'menopause'
  ...
  if (status === 'done') {
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mb-6">You&apos;ve been removed from <strong>Midlife Signalbook</strong>. No more emails from us.</p>
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center">
      ...
      <p className="text-gray-600 mb-2">
        Unsubscribe <strong>{decoded || 'your email'}</strong> from <strong>Midlife Signalbook</strong>?
      </p>
