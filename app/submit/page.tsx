...
export const metadata: Metadata = {
  ...
  description:
    'Add your menopause practice to MenopauseDirectory.co. Free listings available. Verified listings with priority placement start at $99/year.',
}
            ...
            <div className="bg-brand-cream rounded-2xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 text-sm">Verified — $99/year</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  '$99/year pays for itself with a single new patient',
                ].map((point, i) => (
